<script>
    ...
    onMount(() => {
        ...
        inView(kraftkoHeading, () => {
            animate(kraftkoHeading, {opacity: [0, 1], y:[20,0 ]}, {easing: "ease-in", duration: 0.5})
        })
...
<div class="flex flex-col justify-center py-28 md:py-52 bg-gray-600">
    <h1 bind:this={heading} class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-tight text-gray-100 sm:text-7xl text-center">
         <!-- --> <br class="py-2" /><span class="relative whitespace-nowrap">
            <svg aria-hidden="true" viewBox="0 0 418 42" class="absolute left-0 top-2/3 h-[0.58em] w-full fill-background" preserveAspectRatio="none">
                ...
                </path></svg><span class="relative text-7xl md:text-9xl text-gray-100">CRAFTY</span>
        </span> <!-- -->
    </h1>
    <div class="flex justify-center px-4 pt-12 w-full">
        <label bind:this={searchBar} class="relative text-gray-400 w-full md:w-1/2 focus-within:text-gray-600 block">
              <svg class="pointer-events-none w-6 h-6 absolute top-1/2 transform -translate-y-1/2 left-3" fill="currentColor" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M31.707 30.282l-9.717-9.776c1.811-2.169 2.902-4.96 2.902-8.007 0-6.904-5.596-12.5-12.5-12.5s-12.5 5.596-12.5 12.5 5.596 12.5 12.5 12.5c3.136 0 6.002-1.158 8.197-3.067l9.703 9.764c0.39 0.39 1.024 0.39 1.415 0s0.39-1.023 0-1.415zM12.393 23.016c-5.808 0-10.517-4.709-10.517-10.517s4.708-10.517 10.517-10.517c5.808 0 10.516 4.708 10.516 10.517s-4.709 10.517-10.517 10.517z"></path> </g></svg>
              <input type="text" name="text" id="text" placeholder="Pretrazi" class="form-input rounded border border-gray-600 p-4 bg-white placeholder-gray-400 text-gray-500 appearance-none w-full block pl-14 focus:outline-none">
        </label>
    </div>
    <h2 bind:this={subHeading} class="text-gray-100 text-center py-4 text-xl font-bold">Kreativnost na jednom mjestu</h2>
</div>
{#if loggedIn}
    <div class="flex w-full justify-center pt-20">
        <input class="px-4 py-2 bg-gray-50/15 rounded text-gray-600 placeholder:text-gray-400" placeholder="Pretraži proizvode" />
    </div>
{:else}
    <div class="md:px-48">
        ...
        <div class="flex justify-center py-20 w-full text-center ">
            <button bind:this={tagButton} class="flex justify-center px-3 py-2 rounded-full border tracking-widest text-xl md:text-2xl bg-gray-600 text-gray-50 font-bold min-w-80 hover:bg-gray-500 transition-all transform duration-300 ease-in">VIŠE
                    <svg class="w-12 pl-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M13.4697 5.46967C13.7626 5.17678 14.2374 5.17678 14.5303 5.46967L20.5303 11.4697C20.8232 11.7626 20.8232 12.2374 20.5303 12.5303L14.5303 18.5303C14.2374 18.8232 13.7626 18.8232 13.4697 18.5303C13.1768 18.2374 13.1768 17.7626 13.4697 17.4697L18.1893 12.75H4C3.58579 12.75 3.25 12.4142 3.25 12C3.25 11.5858 3.58579 11.25 4 11.25H18.1893L13.4697 6.53033C13.1768 6.23744 13.1768 5.76256 13.4697 5.46967Z" fill="#ffffff"></path> </g></svg>
            </button>
        </div>
    </div>
    <div class="flex flex-col bg-gray-200 py-8 md:px-48 gap-8 justify-center">
        <h1 bind:this={kraftkoHeading} class="text-2xl text-gray-600 font-extrabold text-center">Razgovaraj s Kraftkom</h1>
        <div class="text-center pt-64">
            <button bind:this={kraftkoButton} class="px-3 py-2 rounded-full border tracking-widest text-xl md:text-2xl bg-gray-600 text-gray-50 font-bold min-w-80 hover:bg-gray-500 transition-all transform duration-300 ease-in">KLIKNI OVDJE</button>
        </div>
    </div>
