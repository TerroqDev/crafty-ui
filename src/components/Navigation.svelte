	...
	>
		...
		>
			...
			<li bind:this={kontakt} class="text-3xl p-4 tracking-tighter w-full">
				<a on:click={() => (isMenuOpen = false)} href="/kontakt" class="hover:text-gray-600"> Kontakt </a>
			</li>
		</ul>
	</nav>
</nav>
